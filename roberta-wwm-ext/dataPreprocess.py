...
# 划分数据集
file_list = glob.glob('/Users/herongwei/chinese_ner_tianchi/data/train/*.txt')

train_filelist, val_filelist = train_test_split(file_list,test_size=0.2,random_state=2020)

# 训练集处理
data_dir = '/Users/herongwei/chinese_ner_tianchi/data/train/'
for file in train_filelist:
    ...
    w_path = '/Users/herongwei/chinese_ner_tianchi/data/train_new'
    w_file = file_name
...
for file in val_filelist:
    ...
    r_ann_path = os.path.join(data_dir, "%s.ann" % file_name)
    r_txt_path = os.path.join(data_dir, "%s.txt" % file_name)
    w_path = '/Users/herongwei/chinese_ner_tianchi/data/val_new'
    w_file = file_name
    from_ann2dic(r_ann_path, r_txt_path, w_path,w_file)


# 合并训练集
w_path = "/Users/herongwei/chinese_ner_tianchi/data/train.txt"
for file in os.listdir('/Users/herongwei/chinese_ner_tianchi/data/train_new/'):
    path = os.path.join("/Users/herongwei/chinese_ner_tianchi/data/train_new", file)
...
# 合并验证集
w_path = "/Users/herongwei/chinese_ner_tianchi/data/val.txt"
for file in os.listdir('/Users/herongwei/chinese_ner_tianchi/data/val_new/'):
    path = os.path.join("/Users/herongwei/chinese_ner_tianchi/data/val_new/", file)
    if not file.endswith(".txt"):
        continue
    q_list = []
...
for file in val_filelist:
    file_name = file.split('/')[-1].split('.')[0]
    r_ann_path = os.path.join("/Users/herongwei/chinese_ner_tianchi/data/train/", "%s.ann" % file_name)
    os.system("cp %s %s"%(file,"/Users/herongwei/chinese_ner_tianchi/data/val_data/"))
    os.system("cp %s %s"%(r_ann_path,"/Users/herongwei/chinese_ner_tianchi/data/val_data/"))
    print(file)